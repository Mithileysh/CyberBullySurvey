...
csv_data = CSV.open('contents/data/cyberbullying_data.csv', headers: true, :encoding => 'windows-1251:utf-8')
...
File.open('contents/data/cyberbullying_data2.json', 'w') { |file| file.write(JSON.pretty_generate(json_data)) }
